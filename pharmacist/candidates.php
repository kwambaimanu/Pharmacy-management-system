        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> New Prescription</a>
            </div>
            <div class="box-body">
...
<?php include 'includes/scripts.php'; ?>
 <?php include 'includes/prescription_modal.php'; ?>
<script>
$(function(){
